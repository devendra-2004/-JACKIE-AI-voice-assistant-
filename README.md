...
- To activate the environment ``` conda activate jackiee ```
...
## Code Structure
    ...
    ├── driver
    ├── jackiee             # Main folder for features 
    │   ├── config          # Contains all secret API Keys
    │   ├── features        # All functionalities of JARVIS 
    │   └── utils           # GUI images
    ├── __init__.py         # Definition of feature's functions
    ├── gui.ui              # GUI file (in .ui format)
    ├── main.py             # main driver program of Jackiee
...
## Contribute
Please read [CONTRIBUTING.md](https://github.com/Gladiator07/JACKIEE/blob/master/CONTRIBUTING.md) for details on our code of conduct, and the process for submitting pull requests.

## License
This project is licensed under [MIT License](https://github.com/devendra2004/JACKIEE/blob/master/LICENSE) 2021 Atharva Ingle
